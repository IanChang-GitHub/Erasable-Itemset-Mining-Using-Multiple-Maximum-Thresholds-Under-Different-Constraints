...
public class Mei
{
    ...
    static	double totalGain = 0, maxMGT;                 //記錄「全部產品的 profit 值總和」
	...
	static ElementaryTable EI = new ElementaryTable();
	...
	static ElementaryTable C1 = new ElementaryTable();	
	//static ElementaryTable C2 = new ElementaryTable();
	...
	*/
	...
	public static void main(String[] args)
    {
        ...
        {	
			...
			System.out.println("Erasable Itemset Mining Algorithm with maximum constraint using tree structure");
 			System.out.println("=====================================");
			//System.out.println("minGain: "+ minGain);
 			filePath=getDatabase("thesis"); //設定資料庫檔案路徑
 			filePath2=getThreshold("thesis_");//設定門檻值檔案路徑
			...
			Find_E1  fe1 = new Find_E1(dbData, transProfit, item, maxGainThreshold, totalGain, maxMGT); //mining erasable 1-itemsets(product,profit,threshold,總profit)
			EI = fe1.getE1();                                      //取得 Erasable 1-itemsets
			C1 = fe1.getC1();
			...
			if(C1.size() > 1)
			{
				...
				Find_E2  fe2 = new Find_E2(EI, transProfit, maxGainThreshold, C1);
				//E2 = fe2.getE2();
				//C2 = fe2.getC2();
				E2_memory = fe2.getE2_memory();
				//E2_Num=fe2.getE2().size();
				CK2_Num = fe2.getCK_Num();
				//NE2_Num=CK2_Num-E2_Num; //NE2 = CE2 - E2
				...
				*/
				...
				//Find_ErasableItemsets efi = new Find_ErasableItemsets(dbData, transProfit, maxGainThreshold, totalGain, E1, E2, maxLength);
				...
				//Output_Info oi = new Output_Info(filePath , maxGainThreshold, EI, totalGain);
			...
			System.out.println(((double)(r.totalMemory() - r.freeMemory())/1024/1024));
			usedStr = String.valueOf(((int) (r.totalMemory() - r.freeMemory()))/1024)+ "K  " + String.valueOf(((double) (r.totalMemory() - r.freeMemory()))/1024/1024) + "MB used";  
			...
			System.out.println("-------------------------------------------------------------");
			System.out.println();
			System.out.println(" Mining Erasable Itemsets on original method  在記憶體te方面，共使用: "+usedStr); 
			...
			System.out.println(" Number of EI : "+EI.size());
	        ...
	        System.out.println("Used heap memory: " + heapMemoryUsage.getUsed() + " B");
	        System.out.println("Used heap memory: " + heapMemoryUsage.getUsed() / 1024 + " KB");
	        System.out.println("Max heap memory: " + heapMemoryUsage.getMax() / 1024 + " KB");
			*/
