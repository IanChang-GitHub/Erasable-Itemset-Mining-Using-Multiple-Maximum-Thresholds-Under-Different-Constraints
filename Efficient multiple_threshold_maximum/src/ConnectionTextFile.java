...
public class ConnectionTextFile 
{
    ...
    public ConnectionTextFile(String FileName,String FileName2) 
    {
        ...
        public double getmaxMGT() // 回傳「 Total Gain 值」
        {  			  			
            return maxMGT;
        }
        //------------------------------------------------------------
    ...
    public void buildThreshold() //讀取多門檻
    {
        try
        {
            ...
            {    
         		...
         		int tempItem=Integer.parseInt(thresh[0]);
         		item[Integer.parseInt(thresh[0])]= (char)tempItem;
                ...
                if (Double.parseDouble(thresh[1])*totalGain > maxMGT) {
                	maxMGT = Double.parseDouble(thresh[1])*totalGain;
                }
