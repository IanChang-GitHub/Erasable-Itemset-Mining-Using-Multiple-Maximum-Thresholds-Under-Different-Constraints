...
public class Erasable_average 
{
	...
	//static ElementaryTable E3 ;	//記錄「 High Maximum Upper-Bound Utility 3-itemsets 」
	...
	*/
	...
	public static void main(String[] args)
    {
        ...
        {	
			...
			System.out.println("Erasable Itemset Mining Algorithm with average constraint");
 			System.out.println("=====================================");
			//System.out.println("minGain: "+ minGain);
 			//filePath=getDatabase("D100KI0.05KA10"); //設定資料庫檔案路徑
			...
			Find_E1  fe1 = new Find_E1(dbData, transProfit, item, maxGainThreshold, totalGain); //mining erasable 1-itemsets(product,profit,threshold,總profit)
			...
			if(C1.size()!=0)
			{
				...
				Find_E2  fe2 = new Find_E2(dbData, transProfit, maxGainThreshold, totalGain, E1, C1);
				E2 = fe2.getE2();
				C2 = fe2.getC2();
				...
				*/
				...
				Find_ErasableItemsets efi = new Find_ErasableItemsets(dbData, transProfit, maxGainThreshold, totalGain, E1, E2, C1, C2, maxLength);
			...
			System.out.println("-------------------------------------------------------------");
			System.out.println();
			System.out.println(" Mining Erasable Itemsets on original method average 在記憶體te方面，共使用: "+usedStr); 
