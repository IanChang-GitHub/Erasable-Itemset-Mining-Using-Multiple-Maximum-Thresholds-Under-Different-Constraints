...
public class Find_ErasableItemsets
{
	  ...
	  long tempMemory=0, memory = 0;
	
	public Find_ErasableItemsets(char[][] dbData, int[] transProfit, double minGain,  double totalGain, ElementaryTable E1, ElementaryTable E2, int maxLength)
    {
	      try{			
				    //---------------------------
				    //宣告變數區
