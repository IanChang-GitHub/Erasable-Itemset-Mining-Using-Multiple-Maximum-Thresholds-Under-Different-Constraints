...
public class Erasable 
{
    ...
    static	double totalGain = 0;                 //total_gain
    ...
    static	long freeMemory, totalMemory, startMemory, endMemory, tempMemory=0; 		//宣告未使用前記憶體狀況與使用後記憶體狀況，兩者相減就是使用記憶體量！
    static double mbMemory;//, testMemory1,testMemory2;
	...
	public static void main(String[] args)
    {
        ...
        {	
			...
			//testMemory1= ((double)r.totalMemory() - r.freeMemory())/1024/1024;
			//minGain=getThreshold.6);
			System.out.println("Erasable Itemset Mining Algorithm ");
 			System.out.println("=====================================");
			System.out.println("minGain: "+ minGain);
			FilePath=getDatabase("item-2"); //設定檔案路徑
			minGain=getThreshold(0.2); //設定threshold
			...
			Find_E1  fe1 = new Find_E1(dbData, transProfit, minGain, totalGain); //mining erasable 1-itemsets(product,profit,threshold,總profit)
			...
			if(E1.size()!=0)
			{
				...
				Find_E2  fe2 = new Find_E2(dbData, transProfit, minGain, totalGain, E1);
				E2 = fe2.getE2();
				...
				*/
				...
				Find_ErasableItemsets efi = new Find_ErasableItemsets(dbData, transProfit, minGain, totalGain, E1, E2, fe1.getCK_Num());
				//Ek_memory = efi.getEK_memory();
			...
			//r.gc();
			//testMemory2= ((double)r.totalMemory() - r.freeMemory())/1024/1024;
			...
			//System.out.println(" testMemory1: "+ testMemory1);
			//System.out.println(" testMemory2: "+ testMemory2);
			System.out.println(" minGain: "+minGain);   
