...
public class Find_E1
{
	...
	public Find_E1(char[][] dbData, int[] transProfit, double[] maxGainThreshold, double upperThreshold) //建構子
	{
		try
		{		
			//------------------------------------------
			...
			this.upperThreshold = upperThreshold; //總收益
