...
public class Find_E2 {
	...
	public Find_E2(char[][] dbData, int[] transProfit, double[] maxGainThreshold, double upperGain, ElementaryTable C1)
	{
		try{
			//------------------------------------------
			// 設定「初始值」
		...
		try{			
			...
			Set set3 = C2.ElementSet();
     		...
     		while (iter3.hasNext())    
 			{
				...
				double Fun_Constraint = function.calculate_avg(nx3.getKey(), maxGainThreshold, upperGain);
                ...
                System.out.println(" Gain_Threshold: "+ Fun_Constraint);
                */
